...
def toPowspec(image_num):
    #print(image_num)
    image = fits.open('/tigress/jialiu/lenstools_storage/Om0.29997_As2.10000_mva0.00000_mvb0.00000_mvc0.00000_h0.70000_Ode0.69995/1024b512/Maps05/WLconv_z0.50_' + '{:04d}'.format(image_num) + 'r.fits')[0].data.astype(float)
...
#fig2.suptitle("Fig. 9: Correlation Matrix Heat Maps - Noiseless Maps, 1 Arcminute Smoothing", fontsize = "17")
...
#fig2.savefig("corrmat_allnoiseless.png", bbox_inches = "tight")
...
#ax1.set_title("Fig. 3: Mean Power Spectra - Noiseless Maps, 1 Arcminute Smoothing")
...
#fig3.savefig("powermean_allnoiseless.png", bbox_inches = 'tight')
