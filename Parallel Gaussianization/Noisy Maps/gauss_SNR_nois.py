...
fig2, (ax1, ax2) = plt.subplots(nrows=1, ncols=2, figsize = (13, 13))
axlist = [ax1, ax2]

fig2.suptitle("Fig. 10: Correlation Matrix Heat Maps - Unfiltered Noisy Maps, No Smoothing", y = 2.0, fontsize = "20")
