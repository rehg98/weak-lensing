...
fig1.savefig("fnoisycovar_gauss.png")
...
ax.set_title('Correlation Matrix Heat Map - Noisy (Filtered), Gaussianized')
...
fig2.savefig("fnoisycorrmat_gauss.png")
...
ax1.set_title("Mean Power Spectrum -- Noisy Maps (Filtered), Gaussianized, Unsmoothed (7/27/17)")
ax1.set_ylabel(r'$\frac{\ell (\ell + 1) C_\ell}{2\pi}$', fontsize = 20)
ax1.set_xlabel(r'$\ell$', fontsize = 20)
ax1.set_xlim(1e2, 1e4)
fig3.savefig("fnoisypowermean_gauss.png", bbox_inches = 'tight')
...
for p in powspecs:
    plt.loglog(ells, p)
plt.title("All Power Spectra -- Noisy Maps (Filtered), Gaussianized, Unsmoothed (7/27/17)")
plt.ylabel(r'$\frac{\ell (\ell + 1) C_\ell}{2\pi}$', fontsize = 20)
plt.xlabel(r'$\ell$', fontsize = 20)
fig4.savefig("fnoisypowerspecs_gauss.png", bbox_inches = 'tight')
